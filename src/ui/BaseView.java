...
public class BaseView {
    ...
    public @FXML Button noticeBtn;
    public @FXML Label noticeLabel;
    public @FXML StackPane noticePane;

    public @FXML ImageView logoD;
    public @FXML ImageView logoU;
    public @FXML ImageView logoB;
    public @FXML ImageView logoI;
    public @FXML ImageView logoO;
